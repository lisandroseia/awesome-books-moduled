...
},{}],"modules/collection.js":[function(require,module,exports) {
"use strict";
...
var txt = document.querySelector('form > p');
...
var Collection = /*#__PURE__*/function () {
  ...
  _createClass(Collection, [{
    ...
    value: function add(data) {
      if (this.books.filter(function (item) {
        return item.author === data.author && item.title === data.title;
      }).length > 0) {
    ...
    value: function remove() {
      ...
      var removeBtns = document.querySelectorAll('.remove-button');
      removeBtns[removeBtns.length - 1].addEventListener('click', function (evt) {
        _this.removeFromColl(evt.target);
    ...
    value: function display(data) {
      if (this) {
        ...
        div.innerHTML = "<h3>\"".concat(data.title, "\" by</h3>\n                      <h3>").concat(data.author, "</h3>\n                      <button data-value=\"").concat(data.title, "-").concat(data.author, "\" type=\"button\" class =\"remove-button\">Remove</button>");
        bookSection.appendChild(div);
      }
    }
  }, {
    key: "removeFromColl",
    value: function removeFromColl(data) {
      var arr = data.getAttribute('data-value').split('-');
      this.books = this.books.filter(function (item) {
        return item.title + item.author !== arr[0] + arr[1];
      });
      this.populateStorage();
    }
  }, {
...
var _book = _interopRequireDefault(require("./modules/book"));
...
if (localStorage.getItem('bookCollection')) {
  var localBooks = JSON.parse(localStorage.getItem('bookCollection'));
  localBooks.bookColl.forEach(function (element) {
    coll.add(new _book.default(element.title, element.author));
  });
}

submitBtn.addEventListener('click', function () {
  coll.add(new _book.default(inputTitle.value, inputAuthor.value));
});
/* navigation */

var navAdd = document.querySelector('#addNew');
var navList = document.querySelector('#list');
var navContact = document.querySelector('#contact');
var booksWindow = document.querySelector('.books-section');
var addWindow = document.querySelector('.add-books');
var contactWindow = document.querySelector('.contact-section');
navAdd.addEventListener('click', function (evt) {
  evt.preventDefault();
...
navContact.addEventListener('click', function (evt) {
  evt.preventDefault();
...
setInterval(function () {
  ...
  dateSection.textContent = dt.toLocaleString(_luxon.DateTime.DATETIME_FULL_WITH_SECONDS).slice(0, -5);
}, 1000);
},{"./modules/book":"modules/book.js","./modules/collection.js":"modules/collection.js","luxon":"node_modules/luxon/build/cjs-browser/luxon.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/awesome-books-moduled.e31bb0bc.js.map